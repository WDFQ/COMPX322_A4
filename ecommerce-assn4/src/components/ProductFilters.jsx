export function ProductFilters({ search, setSearch, filterOption, setFilterOption, priceSort, setPriceSort, categoryData }) {
    return (
        <div className="flex flex-wrap gap-4 items-center p-4 rounded-lg ">
            {/* search bar */}
            <input className="border border-gray-300 px-3 py-2 " type="text" placeholder="Search products" value={search} onChange={(e) => setSearch(e.target.value)} />
